...
//     version 1.4.4
//     from Assets/LevelEditor/Inputs/PlayerEditorInput.inputactions
//
...
public partial class @PlayerEditorInput : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @PlayerEditorInput()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""PlayerEditorInput"",
    ""maps"": [
        {
            ""name"": ""Gameplay"",
    ...
    {
        private @PlayerEditorInput m_Wrapper;
        public GameplayActions(@PlayerEditorInput wrapper) { m_Wrapper = wrapper; }
